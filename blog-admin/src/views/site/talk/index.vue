    ...
    <div class="app-container">
        ...
        <el-row :gutter="10" class="mb8">
            <el-col :span="1.5">
                ...
                <el-button :disabled="!multipleSelection.length" v-if="canDeleteBatch" type="danger" icon="el-icon-delete"
                    size="small" @click="handleDeleteBatch(null)">批量删除
                </el-button>
            </el-col>
            <right-toolbar :showSearch.sync="showSearch" @queryTable="getTalkList"></right-toolbar>
        </el-row>
            ...
            <el-table border :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
                ...
                <el-table-column label="操作" align="center">
                    <template slot-scope="scope">
                        ...
                        <el-button v-if="canDeleteBatch" @click="handleDeleteBatch(scope.row)" type="danger"
...
<script>
import { getTalkList, deleteTalk, addTalk, updateTalk, infoTalk } from "@/api/talk"
...
export default {
    ...
    computed: {
        ...
        canList() {
            return hasAuth(this.pres, '/system/talk/list')
        },
        canAdd() {
            return hasAuth(this.pres, '/system/talk/add')
        },
        canUpdate() {
            return hasAuth(this.pres, '/system/talk/update')
        },

        canDeleteBatch() {
            return hasAuth(this.pres, '/system/talk/delete')
        }
    },
    created() {
        this.getTalkList();
